...
<form method='POST' action="{{route('doc_file.update',$id)}}" enctype="multipart/form-date">
@method('PATCH')
{{csrf_field()}}
<div class="form-group">
<label>Doc_File_initiator_id</label>
<input class="form-control" type="text" name='Doc_File_initiator_id' value="{{$varDoc_File->Doc_File_initiator_id}}" >
</div>
...
<input class="form-control" type="text" name='Doc_File_department_id' value="{{$varDoc_File->Doc_File_department_id}}" >
</div>

<div class="form-group">
<label>Doc_File Office</label>
<input class="form-control" type="text" name='Doc_File_office_id' value="{{$varDoc_File->Doc_File_office_id}}" >
</div>
...
<div class="form-group">
<label>Doc_File_task_id</label>
<input class="form-control" type="text" name='Doc_File_task_id' value="{{$varDoc_File->Doc_File_task_id}}" >
</div>
<div class="form-group">
